...
void main() {
  group('Propagation Correctness', () {
    test('source -> derive -> observe propagates value', () async {
    ...
    test('derive equality-gates: does not propagate when output unchanged', () async {
      final (src, setSrc) = createSource<int>(1);
      ...
      expect(observeEvals, 1); // Sink does NOT re-evaluate because derived output remained strictly equals
      ...
      expect(observeEvals, 2); // Sink evaluates because derived output changed to `true`
